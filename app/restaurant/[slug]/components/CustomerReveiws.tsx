...
export default function CustomerReveiws({reviews}: {reviews: Review[]}) {
    return (
        <div>
            <h1 className='font-bold text-xl mt-10 mb-7 border-b pb-5'> {reviews.length === 0 ? "" : reviews.length === 1 ? `what ${reviews.at(0)?.first_name} is saying` :  `What ${reviews.length} people are saying`} </h1>
                ...
                return (
                        <div className="border-b pb-7 mb-7" key={review.id}>
                            ...
                            <div className="w-1/6 flex flex-col items-center">
                                ...
                                <h1 className='font-bold text-white text-2xl text-center pl-3'> {review.first_name.at(0)}{review.last_name.at(0)} </h1>
                                </div>
                            ...
                            <div className='ml-10 w-5/6'>
                                ...
                                <div className='flex items-center'>
                                    <div className='flex mr-5 space-x-2'>
                                        ...
                                        <p className=""> {review.rating.toFixed(1)} </p>
                                    </div>
                                </div>
                                {/* REVIEW */}
                                <div className='mt-5'>
